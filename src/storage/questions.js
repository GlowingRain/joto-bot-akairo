module.exports = {
    questions: {
        responses: {
            "xp": "Recibes 15XP por cada mensaje que envías dentro de un intervalo de 1 minuto. Pasado ese minuto vuelves a obtener los 15XP si mandas un mensaje.",
            "respeto": "Respetar a los usuarios y el staff. Cabe destacar que muchas de las normas por más que no estén escritas, poseen de su lado el sentido común, usa la cabeza y no seas uno más del montón.",
            "bardo": "No hacer **\"bardo\"**. Las peleas sin razón aparenta no se van a perdonar, cualquier tipo de bardo tampoco.",
            "spam": "El spam está estrictamente prohibido; de esto no se exceptúan las invitaciones innecesarias a un servidor de Discord.",
